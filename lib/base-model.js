    ...
    value: function _validateAttributes(modelJson) {
      ...
      Object.keys(modelJson).forEach(function (attributeName) {
        ...
        if ((0, _propUtils.identify)(expectedAttr) === _propUtils.types.object) {
          ...
          acceptedTypes = (0, _propUtils.comparePropertyToType)(expectedAttr.validate, _propUtils.types.array) ? { ignore: [expectedType].concat(_toConsumableArray(expectedAttr.acceptedTypes)) } : acceptedTypes;
